...
function check1(btn) {
    ...
    // 버튼이 클릭 될 때 마다 pink <-> yellow
    if(bgColor == "yellow") btn.style.backgroundColor = "pink";
...
// #test1-2 버튼 클릭 시
// #test1-1 의 onclic 이벤트 리스너의 이벤트 핸들러 제거하기
...
test2.addEventListener("click", function() {
    // 투명도 1 (불투명) -> 투명도 0 (투명) 0.1씩 감소

    // 현재 #test2의 투명도 확인
    let curr = test2.style.opacity;

    // 맨처음에는 투명도 '' 이므로 -> 1을 대입해줌
    if(curr == "") {
