...
document.querySelector("#btn1").addEventListener("click", () => {
    ...
    // 5. 이전/다음 형제 노드 찾기
    // (이전 형제 노드 : 요쇼.previousSibling)
    // (다음 형제 노드 : 요쇼.nextSibling)

    // -> 탐색용 코드는 연달아서 작성 가능!

    // test.childNodes[9]의 다음 다음 형제의 노드 선택
    // == test.childNodes[11]
    ...
    list[11].append("12345", "aasdf", "가나다라");
...
btn2.addEventListener("click", () => {
    ...
    // test2의 모든 자식 요소 얻어오기
    console.log(test2.children);

    // test2의 첫번쨰 자식 요소 확인하기
